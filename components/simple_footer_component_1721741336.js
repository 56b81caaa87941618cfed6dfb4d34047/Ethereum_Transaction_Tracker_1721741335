...
*/
Vue.component("simple_footer_component_1721741336", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay up-to-date with the latest Ethereum transactions in real-time. EtherScan makes it easy to explore, monitor, and analyze the Ethereum blockchain.
                    </div>
                </div>
            </div>
        </footer> 
